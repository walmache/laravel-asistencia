                ...
                <div class="card-body p-3">
                    <div class="row">
                        <div class="col-md-6 mb-3">
                            ...
                            <div class="input-group border border-secondary rounded">
                                ...
                                <input type="text" class="form-control border-0 form-control-sm @error('name') is-invalid @enderror" id="name" name="name" value="{{ old('name', $event->name) }}" placeholder="Ingrese el nombre del evento" required>
                                @error('name')
                    ...
                    <div class="mb-3">
                        ...
                        <div class="input-group border border-secondary rounded">
                            ...
                            <textarea class="form-control border-0 form-control-sm @error('description') is-invalid @enderror" id="description" name="description" rows="2" placeholder="Ingrese la descripción del evento">{{ old('description', $event->description) }}</textarea>
                            @error('description')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                    ...
                    <div class="row">
                        <div class="col-md-6 mb-3">
                            ...
                            <div class="input-group border border-secondary rounded">
                                ...
                                <input type="datetime-local" class="form-control border-0 form-control-sm @error('start_at') is-invalid @enderror" id="start_at" name="start_at" value="{{ old('start_at', $event->start_at ? $event->start_at->format('Y-m-d\TH:i') : '') }}" required>
                                @error('start_at')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <div class="input-group border border-secondary rounded">
                                ...
                                <input type="datetime-local" class="form-control border-0 form-control-sm @error('end_at') is-invalid @enderror" id="end_at" name="end_at" value="{{ old('end_at', $event->end_at ? $event->end_at->format('Y-m-d\TH:i') : '') }}" required>
                                @error('end_at')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
